...
export const updateCatalogueWStruct = async (new_entry: CatalogueEntry) => {
  ...
  var catalogue = JSON.parse(
    fs.readFileSync(process.env.CATALOGUE as string, "utf-8")
  );
  ...
  fs.writeFileSync(
    process.env.CATALOGUE as string,
