...
def apply_params_to_default(args):
    ...
    # Paths
    # TODO: Enter paths to file and output
...
async def make_input_config(arguments: dict):
    ...
    t_inputfile.text = '/home/rtviii/dev/django_react_standalone/ribosome.xyz-backend/static/pdb-structs/5nwy-tunnel-w-30.pdb'

    t_workdir = SubElement(Tunnels, 'WorkingDirectory')
    t_workdir.text = '/home/rtviii/dev/django_react_standalone/ribosome.xyz-backend/static/mole-outputs/'
